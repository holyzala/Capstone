...
namespace SharedSheepTest.ScoreSheetTests
{
    ...
    public class ScoreSheetTests
    {
        ...
        public void AddGameScoreTest()
        {
            ...
            score.AddGameScore(p1, p3, false, false, 65);
            score.AddGameScore(p2, p1, false, false, 50);
            score.AddGameScore(p3, null, false, false, 90);
            score.AddGameScore(p4, p5, true, false, 0);
            score.AddGameScore(p5, p3, false, false, 120);
